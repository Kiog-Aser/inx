...
/** One highlight range, possibly spanning pages (and spines). Word indexes are page-local. */
...
class EpubAnnotationUi {
 ...
 private:
  ...
  void drawSpanOnCurrentPage(EpubActivity& act, const HighlightSpan& span, bool expandHyphen);
  ...
  void expandSpanHyphenOnCurrentPage(HighlightSpan& span) const;
